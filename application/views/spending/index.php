<div class="card shadow mb-4">
  <div class="card-body">
    ...
    <div class="table-responsive">
    	<table class="table table-bordered table-hover" id="spending-table">
    	  <caption>Data Pengeluaran Kas</caption>
    	  <thead>
    	    <tr>
    	      <th scope="col">No</th>
...
<div class="modal fade" id="spending-modal" tabindex="-1" role="dialog" aria-labelledby="spending-modal-title" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="spending-modal-title"></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form id="form-spending">
